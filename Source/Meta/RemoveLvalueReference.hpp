...
namespace Alice::Meta
{
    namespace Detail
    {
        template<class Self> struct RemoveLvalueReference final
        {
            constexpr compl RemoveLvalueReference() noexcept = delete;
        ...
        template<class Self> struct RemoveLvalueReference<Self&> final
        {
            constexpr compl RemoveLvalueReference() noexcept = delete;
